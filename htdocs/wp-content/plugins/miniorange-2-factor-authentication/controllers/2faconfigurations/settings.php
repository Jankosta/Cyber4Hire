...
global $wp_roles;
$enable_custom_redirect = get_site_option( 'mo2f_enable_custom_redirect' );
$custom_login_urls      = (array) get_option( 'mo2f_custom_login_urls', array( wp_get_current_user()->roles[0] => home_url() ) );
