<?php
/**
 * This file contains functions regarding IP Blocking and Whitelisting
 *
...
foreach ( $whitelisted_ips as $whitelisted_ip ) {
	echo '<tr><td>' . esc_html( $whitelisted_ip->ip_address ) . '</td><td>' . esc_html( gmdate( 'M j, Y, g:i:s a', $whitelisted_ip->created_timestamp ) ) . "</td><td><a onclick=removefromwhitelist('" . esc_js( $whitelisted_ip->id ) . "')>Remove</a></td></tr>";
}
